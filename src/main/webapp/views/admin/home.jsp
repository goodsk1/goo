...
<head>
    ...
    %>
    <!-- 下面是easyui的环境 -->
    <link rel="stylesheet" href="${sup}/static/after/jquery-easyui-1.6.7/themes/icon.css" type="text/css"></link>
    <link rel="stylesheet" href="${sup}/static/after/jquery-easyui-1.6.7/themes/default/easyui.css"
          type="text/css"></link>
    <script type="text/javascript" src="${sup}/static/after/jquery-easyui-1.6.7/jquery.min.js"></script>
    <script type="text/javascript" src="${sup}/static/after/jquery-easyui-1.6.7/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="${sup}/static/after/jquery-easyui-1.6.7/locale/easyui-lang-zh_CN.js"></script>
    <script type="text/javascript" src="${sup}/static/fore/js/views/adminJs/adminMain.js"></script>
    <script src="${sup}/static/fore/js/libs/angular.min.js"></script>
    <title>luckin后台管理</title>
    <style type="text/css">
        body {
    ...
    <table style="padding: 5px" width="100%">
        <tr>
            ...
            <div style="font-size: 15px;position:absolute; right:0; bottom:0;">
                <span>欢迎:${sessionScope.Admin.adminName}</span>|
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        ...
        <div title="合作厂家管理" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
            <a href="javascript:openTab('厂家查询','admin/toManufactorList','icon-writeblog')" class="easyui-linkbutton"
...
<div region="south" style="height: 25px;padding: 5px" align="center">
    div region="south" style="height: 25px;padding: 5px" align="center">
    Copyright © 2018 luckin后台系统 版权所有
</div>
</div>
</body>
</html>
