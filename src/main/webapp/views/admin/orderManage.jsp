...
<head>
    ...
    <script type="text/javascript" charset="utf8"
            src="${sup}/static/fore/js/libs/jquery.dataTables.js"></script>
...
<div ng-controller="adminOrderCtrl">
    ...
    <div class="modal fade" id="orderSnackModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
    ...
    <div class="modal fade" id="orderSnackUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" style="width: 800px; height: 500px">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="orderdetailUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" style="width: 800px; height: 500px">
            <div class="modal-content">
                <div class="modal-header">
...
<script type="text/javascript" src="${sup}/static/fore/js/views/adminJs/orderManage.js"></script>
</html>