...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${sup}/static/fore/css/libs/jquery.dataTables.css">
    <link href="${sup}/static/fore/css/libs/sweetalert.css" rel="stylesheet" type="text/css"/>
    <link href="${sup}/static/fore/css/libs/dataTimeCss.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="${sup}/static/fore/js/libs/jquery.min.js"></script>
    <script type="text/javascript" charset="utf8" src="${sup}/static/fore/js/libs/jquery.dataTables.js"></script>
    <script src="${sup}/static/fore/js/libs/bootstrap.min.js"></script>
    <script type="text/javascript" src="${sup}/static/fore/js/libs/bootbox.min.js"></script>
    <script type="text/javascript" src="${sup}/static/fore/js/libs/sweetalert.min.js"></script>
    <script src="${sup}/static/fore/js/libs/angular.min.js"></script>
    <script src="${sup}/static/fore/js/libs/laydate.js"></script>
    <title>商品信息</title>
</head>
...
<div ng-controller="adminSnackinfoCtrl">
    ...
    <div class="modal fade" id="newAdminSnackinfoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
                    ...
                    <div class="margin-top-15">
                        <form id="adminSnackinfForm">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <button id='addAdminSnackinfo'>添加</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
    ...
    <div class="modal fade" id="updateAdminSnackinfoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" style="width: 800px; height: 500px">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="clearfix" style="margin:0px 15px 0px">
                    <div class="margin-top-15">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <button id='updateAdminSnackinfo'>修改</button>
                                </td>
                            </tr>
                        </table>
                    </div>
...
<script type="text/javascript" src="${sup}/static/fore/js/views/adminJs/snackManage.js"></script>
</html>