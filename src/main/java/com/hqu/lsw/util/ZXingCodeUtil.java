...
public class ZXingCodeUtil {
    ...
    /*public static void main(String[] args) throws WriterException{
        try {  
        	...
        	//getQRCode("https://www.baidu.com/", null, "跳转到百度的二维码");
     ...
     * @return
     */
    public static String getQRCode(String qrUrl, HttpServletRequest request, String productName, File file ) {
        ...
        try {  
            ...
            BufferedImage image = zp.getQR_CODEBufferedImage(content, BarcodeFormat.QR_CODE, 400, 400, zp.getDecodeHintType());
            image.flush();
...
class LogoConfig {
    ...
    /** * Creates a default config with on color {@link #} and off color * {@link #}, generating normal black-on-white barcodes. */
    public LogoConfig(){
